...
class TailAdapter:
    ...
    def install(self):
        ...
        if self.mode != "spinquant_fused":
            # unfused modes emit original h -> logits must use the ORIGINAL head
    ...
    def hidden_basis_exposed(self):
        return {"spinquant_fused": "rotated_h_hat",
                ...
                "wrong_order_gamma_after_rotation": "wrong_rotated_gamma"}[self.mode]
